/*
 * Copy From https://github.com/kawanet/int64-buffer
 * For CBuilder Speed Up
 * License: https://github.com/kawanet/int64-buffer/blob/master/LICENSE
 */
...
const BUFFER = (UNDEFINED !== typeof Buffer) && Buffer;
const UINT8ARRAY = (UNDEFINED !== typeof Uint8Array) && Uint8Array;
const ARRAYBUFFER = (UNDEFINED !== typeof ArrayBuffer) && ArrayBuffer;
const ZERO = [0, 0, 0, 0, 0, 0, 0, 0];
const isArray = Array.isArray || _isArray;
const BIT32 = 4294967296;
const BIT24 = 16777216;
// storage class
let storage; // Array;
// generate classes
let Uint64BE = factory('Uint64BE', true, true);
let Int64BE = factory('Int64BE', true, false);
let Uint64LE = factory('Uint64LE', false, true);
let Int64LE = factory('Int64LE', false, false);
