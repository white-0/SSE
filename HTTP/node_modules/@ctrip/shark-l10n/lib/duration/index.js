...
var DurationFormatter = (function (_super) {
    ...
    DurationFormatter.prototype.getByTemplate = function (key, values) {
        var sharkValue = (0, plural_1.getPlural)(this.getI18n(), key, this.locale, values[0]);
        if (!sharkValue) {
    ...
    DurationFormatter.prototype.unitFromFlag = function (flag) {
        switch (flag) {
            case 'd':
                return new unit_1.DurationDayUnit();
            case 'h':
                return new unit_1.DurationHourUnit();
            case 'm':
                return new unit_1.DurationMinuteUnit();
            case 's':
                return new unit_1.DurationSecondUnit();
            default:
                return null;
        }
    };
