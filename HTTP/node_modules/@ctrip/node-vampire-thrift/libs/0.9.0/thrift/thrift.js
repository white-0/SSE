...
let TException = exports.TException = function(message) {
...
const TApplicationExceptionType = exports.TApplicationExceptionType = {
    UNKNOWN: 0,
    UNKNOWN_METHOD: 1,
...
let TApplicationException = exports.TApplicationException = function(type, message) {
...
TApplicationException.prototype.read = function(input) {
    let ret = input.readStructBegin('TApplicationException');
