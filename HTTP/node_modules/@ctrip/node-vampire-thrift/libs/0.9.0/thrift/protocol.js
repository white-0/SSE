...
let TProtocolException = function(type, message) {
...
let TBinaryProtocol = exports.TBinaryProtocol = function(trans, strictRead, strictWrite) {
    this.trans = trans;
...
TBinaryProtocol.prototype.writeString = function(str) {
    try {
        if (str === void(0)) {
            ...
            str = Buffer.from(str).toString('binary');
        }
    } catch (e) {
        console.log('[ Thrift ] Thrift Write String Error', e);
        str = '';
    }
...
TBinaryProtocol.prototype.readMessageBegin = function() {
    ...
    if (sz < 0) {
        let version = sz & VERSION_MASK;
        if (version != VERSION_1) {
            console.log('[ Thrift ] Bad Version: ' + version);
...
TBinaryProtocol.prototype.readBinary = function() {
    let len = this.readI32();
    return this.trans.read(len);
};

TBinaryProtocol.prototype.readString = function() {
    let r = this.readBinary().toString('utf8');
    return r;
};
