import { buildQuery, promiseTimeout } from '../shared/utils';
...
export function jsonp(url) {
  ...
  var reqUrl = "".concat(url, "?").concat(buildQuery(params));
  ...
  return timeout && timeout > 0 ? promiseTimeout(timeout, promise) : promise;
}