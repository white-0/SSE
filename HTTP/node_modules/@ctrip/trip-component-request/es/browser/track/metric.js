...
import { trackMetric, trackError } from '@ctrip/trip-component-ubt';
...
export function trackAjaxPerformance(url, timing) {
  ...
  return trackMetric(metric);
}
function diff(end, start) {
  return start > 0 && end > start ? end - start : 0;
}
export function trackAjaxTiming(entry) {
...
export function trackAjaxError(e) {
