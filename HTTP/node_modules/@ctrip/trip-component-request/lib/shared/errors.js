...
exports.createRequestError = exports.TimeoutError = exports.SoaResponseStatusError = exports.RequestError = exports.AbortError = void 0;
...
function formateError(error, opt, detail) {
  try {
    ...
    if (detail.data) {
      var ids = (0, _trace.findMessageTraceId)(detail.data);
...
var createRequestError = exports.createRequestError = function createRequestError(err, opt) {
  var detail = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
...
var SoaResponseStatusError = exports.SoaResponseStatusError = /*#__PURE__*/function (_Error4) {
