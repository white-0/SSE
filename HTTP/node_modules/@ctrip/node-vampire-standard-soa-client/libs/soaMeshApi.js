...
exports.SoaClientMeshApi = void 0;
const node_vampire_http_1 = __importDefault(require("@ctrip/node-vampire-http"));
const soaMonitor_1 = require("./utils/soaMonitor");
const node_vampire_soa_service_mapping_1 = __importDefault(require("@ctrip/node-vampire-soa-service-mapping"));
const soaClientBaseApi_1 = require("./soaClientBaseApi");
class SoaClientMeshApi extends soaClientBaseApi_1.SoaClientBaseApi {
    constructor(opts) {
        super(opts);
        /* 初始化
         * @param {Object} opts
         ...
         */
        this.SoaMeshInitCache = null;
        this.soaClientType = soaMonitor_1.CLIENT_TYPE_INTERNAL.Sidecar;
        this.init();
    }
    init() {
        if (this.SoaMeshInitCache)
            return this.SoaMeshInitCache;
        this.SoaMeshInitCache = this.baseInit().then(() => {
            !this.url && (this.url = node_vampire_soa_service_mapping_1.default[this.serviceId] ? `http://${this.urlCheck(node_vampire_soa_service_mapping_1.default[this.serviceId])}.soa.mesh/` : `http://${this.urlCheck(this.serviceId)}.soa.mesh/`);
        }).catch((err) => {
            this.SoaMeshInitCache = null;
            throw err;
        });
...
exports.SoaClientMeshApi = SoaClientMeshApi;
