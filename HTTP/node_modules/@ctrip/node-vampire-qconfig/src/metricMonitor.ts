...
class MetricMonitor {
    ...
    _sendMetric(metricName: string, tag: object, value: number) {
        try {
    ...
    CtriputilCountQconfig(val: number, appId: string): void {
    ...
    QconfigRequestCount(val: number, token: string, type: string, configFile: string) {
    ...
    QconfigExceptionCount(val: number, configFile: string, subEnv: string) {
